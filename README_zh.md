...
<p>logx 是一个Go语言实现的简单、灵活的日志模块，提供了多级日志支持和彩色输出功能。</p>
...
| 测试用例 | 每秒操作数 | 每操作时间 |
| :-------: | :--------: | :--------: |
| Logger 并发 | 450,409 ops/sec | 2,609 ns/op |
| 全局 Logger 并发 | 653,130 ops/sec | 2,865 ns/op |
| Logger 单线程 | 231,024 ops/sec | 4,875 ns/op |
| 全局 Logger 单线程 | 207,585 ops/sec | 5,038 ns/op |

### 吞吐量测试

- **测试环境**: 100个goroutine，每个写入1000条日志
- **总日志数**: 100,000条
- **总耗时**: ~198毫秒
- **吞吐量**: **504,000条日志/秒**
